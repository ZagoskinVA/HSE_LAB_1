TARGET_COLS = ['Артериальная гипертензия',
...
SLEEP_COL = 'Время сна'
SLEEP_TIME_COL = 'Время засыпания'
WAKE_UP_TIME_COL = 'Время пробуждения'
NAN_COLS = ['Возраст курения', 'Сигарет в день', 'Частота пасс кур', 'Возраст алког', 'Возраст курения', 'Сигарет в день', 'Частота пасс кур', 'Возраст алког']
IS_MAN_COL = 'Is Man'
IS_WOMEN_COL = 'Is Women'
PASSIVE_SMOKE_COL = 'Частота пасс кур'
